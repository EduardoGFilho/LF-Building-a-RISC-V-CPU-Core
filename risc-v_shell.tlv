...
\TLV
   ...
   // Get rid of warnings about unused signals
   ...
   //wire is_beq  = dec_bits[9:0] == 10'b000_1100011;
   ...
   // Treat all loads and stores the same
   $is_load = $opcode ==? 7'b0000011 || $opcode ==? 7'b0100011;
   ...
   $result[31:0] =
       ...
       $is_jal ? $pc + 32'd4 :
       $is_jalr ? $pc + 32'd4 :
       $is_slt ? (($src1_value[31] == $src2_value[31]) ? $sltu_rlst : {31'b0, $src1_value[31]}):
       $is_slti ? (($src1_value[31] == $imm[31]) ? $sltu_rlst : {31'b0, $src1_value[31]}):
